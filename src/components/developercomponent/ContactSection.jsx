        ...
        <div className="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg p-8 w-full lg:w-2/3 flex flex-col lg:flex-row gap-10">
          <div className="w-full lg:w-1/2 flex flex-col gap-8">
            <div className="flex justify-start gap-5 items-center">
              ...
              <p>
                <span className="text-xl font-medium dark:text-gray-100">Address</span> <br />
                <span className="text-gray-600 dark:text-gray-300">39, anywhere in the world</span>
              </p>
            </div>
            <div className="flex justify-start gap-5 items-center">
              <div className="bg-primary-developer-template p-4 rounded-full">
              ...
              <p>
                <span className="text-xl font-medium dark:text-gray-100">Email</span> <br />
                <span className="text-gray-600 dark:text-gray-300">showcase@gmail.com</span>
              </p>
            </div>
            <div className="flex justify-start gap-5 items-center">
              <div className="bg-primary-developer-template p-4 rounded-full">
              ...
              <p>
                <span className="text-xl font-medium dark:text-gray-100">Call</span> <br />
                <span className="text-gray-600 dark:text-gray-300">+12345678</span>
              </p>
            </div>
          </div>
