...
function LoginSection() {
  ...
  return (
    <main className={`sm:px-3 sm-max:px-3 flex sm:flex-col-reverse sm-max:flex-col-reverse lg:flex-row w-[100vw] h-[100vh] lg:p-3 xl:p-5 justify-start xl:gap-10 items-center overflow-scroll ${isDarkMode ? "bg-gray-900 text-gray-100" : "bg-white text-black"}`}>
      <section className={`flex justify-center sm:items-center sm-max:items-center xl:items-start gap-10 flex-col xl:w-[50%] sm:rounded-tl-md sm-max:rounded-tl-md sm:rounded-tr-md sm-max:rounded-tr-md sm:h-[95vh] sm-max:h-[95vh] xl:px-10 2xl:px-20 ${isDarkMode ? "bg-gray-900 text-gray-100" : "bg-white text-black"}`}>
        <Link
          to="/"
        ...
        >
          <div>
            ...
            <div>
              <input
                ...
                className={`w-full mt-2.5 h-12 rounded-md border border-solid ${formik.touched.email && formik.errors.email ? "border-red-500" : "border-neutral-300"} max-md:max-w-full ${isDarkMode ? "text-gray-400 bg-gray-800" : "text-neutral-600"}`}                
              />
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`w-full mt-2.5 h-12 rounded-md border border-solid ${formik.touched.password && formik.errors.password ? "border-red-500" : "border-neutral-300"} max-md:max-w-full ${isDarkMode ? "text-gray-400 bg-gray-800" : "text-neutral-600"}`}
              />
          ...
          <button
            type="submit"
            className="justify-center items-center px-16 py-3 mt-4 max-w-full text-white whitespace-nowrap bg-primary hover:bg-primary-hover rounded-md sm:w-full sm-max:w-full max-md:px-5"
