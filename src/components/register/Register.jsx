...
export function ComponentRegister() {
  ...
  return (
    <div className={`sm:px-3 sm-max:px-3 flex sm:flex-col-reverse sm-max:flex-col-reverse lg:flex-row w-[100vw] h-[100vh] lg:p-3 xl:p-5 justify-center items-center xl:gap-10 overflow-scroll ${isDarkMode ? "bg-gray-900 text-gray-100" : "bg-white text-black"}`}>
      <section className={`flex justify-center items-center sm:overflow-scroll sm-max:overflow-scroll lg:overflow-hidden sm:pt-10 sm-max:pt-10 lg:pt-0 sm:items-center sm-max:items-center xl:items-start xl:justify-center gap-5 flex-col xl:w-[50%] sm:rounded-tl-md sm-max:rounded-tl-md sm:rounded-tr-md sm-max:rounded-tr-md sm:h-[95vh] sm-max:h-[95vh] xl:px-10 2xl:px-20 ${isDarkMode ? "bg-gray-900 text-gray-100" : "bg-white text-black"}`}>
        <Link
          to="/"
        ...
        <form className="w-full sm:px-24 sm-max:px-4 xl:p-0 overflow-y-auto" onSubmit={formik.handleSubmit}>
          <div className="w-full flex flex-col gap-1">
            ...
            <Button
              className="justify-center items-center px-16 h-12 mt-4 max-w-full text-white whitespace-nowrap bg-primary rounded-md sm:w-full sm-max:w-full max-md:px-5"
              type="submit"
              color="purple"
              disabled={isLoading}
            >
      ...
      <section className={`lg:h-full flex justify-center items-center lg:rounded-md lg:w-[50%] lg-max:hidden ${isDarkMode ? "bg-gray-900" : "bg-primary"}`}>
