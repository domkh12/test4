...
import { verifyOtp, resendOtp } from "../../redux/verify-user/OtpSlice";
...
function OtpVerification() {
  ...
  return (
    <main className={`flex flex-col items-center justify-center h-screen bg-cover bg-center ${isDarkMode ? "bg-gray-900 text-gray-100" : "bg-white text-black"}`}>
      <ToastContainer />
      <section className="flex sm:flex-col lg:flex-row lg:gap-52 sm-max:flex-col items-center justify-center sm:gap-2 sm-max:gap-2 w-full bg-white dark:bg-gray-900">
        {/* img */}
        <div className="bg-gray-200 dark:bg-gray-700 p-6 rounded-full overflow-hidden">
          <img
        ...
        <div className="flex items-center flex-col justify-center">
          <div className="w-96 flex flex-col justify-center items-center">
            ...
            <h2 className="mt-5 text-3xl font-medium font-sans text-center">
              One more step!
            </h2>
          ...
          <p className="mt-5 text-base font-semibold tracking-normal leading-5 text-center max-md:mt-10">
            ...
            <button
              className="font-bold text-teal-400 dark:text-teal-300"
